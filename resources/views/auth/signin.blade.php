        ...
        <div class="form-login">
            <div class="form-container">
                ...
                <form action="{{ route('auth.signin') }}" method="post">
                    ...
                    <input type="email" id="email" name="email" class="email-input" value="{{ old('email') }}"
                    ...
                    <div class="checkbox-container">
                        ...
                        <a href="{{ route('forgot-password-page') }}" class="signin-link" style="font-size: 12px;">Forgot
                            Password?</a>
                    </div>
                ...
                <div class="signin-text">
                    Don't have an account? <a href="{{ route('auth.signup-page') }}" class="signin-link">Create an
                        Account</a>
                </div>
            </div>
        </div>
