        ...
        <div class="form-container">
            ...
            <form action="{{ route('auth.signup') }}" method="POST">
                <div class="form-step active">
                    ...
                    <input id="email" name="email" class="email-input" value="{{ old('email') }}" placeholder="Enter your work email"/>
                    @error('email')
                ...
                <div class="form-step">
                    ...
                    <input id="email" name="email" class="email-input" value="{{ old('email') }}" placeholder="Enter code"/>
                    @error('email')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                    <div class="email-desc">We've sent a verification code to your email. The code will expire in <b>21</b> seconds. <a href="#" class="signin-link">Resend</a></div>
                    <div class="btn-prev-next">
                        <a href="#" class="btn-form-step btn-prev">previus</a>
                ...
                <div class="form-step">
                    ...
                    <input id="name" name="name" class="name-input" value="{{ old('name') }}" placeholder="Choose a username"/>
                    @error('name')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                    ...
                    @error('password')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                    <div class="email-desc">Use a strong password with at least one uppercase letter, one lowercase letter, one number, and one special character.</div>
                ...
                <div class="form-step">
                    ...
                    <div class="btn-prev-next">
                        <a href="#" class="btn-form-step btn-prev end">previus</a>
                    </div>
